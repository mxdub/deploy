...
Un onglet "Gestion du risque" est également présent, davantage à l'attention des gestionnaires clients, il permet de faire varier le seuil utilisé pour la classification ainsi que la valeur souhaité de *beta* pour le F-score. Le graphique représente les taux de faux positifs et faux négatifs, ainsi que la valeur du F-score en fonction du seuil choisi. 